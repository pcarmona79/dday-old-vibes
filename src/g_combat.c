 ...
 ************************************
 *   $Source: /var/lib/cvs/dday42sk/src/g_combat.c,v $
 *   $Revision: 1.4 $
 *   $Date: 2003/10/20 03:04:12 $
 *
 ***********************************
...
//	int			psave;
	...
	//kernel: not penalty if player is in limbo mode
	if (IsValidPlayer(targ))
		if (targ->client->limbo_mode && mod == MOD_PENALTY)
			return;
