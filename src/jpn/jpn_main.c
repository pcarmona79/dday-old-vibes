...
*/
	...
	Weapon_Bren_Fire = (void (*)(edict_t *ent)) PlayerFindFunction("Weapon_Bren_Fire");
	Weapon_Katana_Fire = (void (*)(edict_t *ent)) PlayerFindFunction("Weapon_Katana_Fire");
	Weapon_Molotov_Fire = (void (*)(edict_t *ent)) PlayerFindFunction("Weapon_Molotov_Fire");
	Weapon_MG42_Fire = (void (*)(edict_t *ent)) PlayerFindFunction("Weapon_MG42_Fire");
}
