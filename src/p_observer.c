 ...
 ************************************
 *   $Source: /var/lib/cvs/dday42sk/src/p_observer.c,v $
 *   $Revision: 1.1.1.1 $
 *   $Date: 2003/10/06 22:56:34 $
 * 
 ***********************************
...
//	client_menu(ent, 14,  "*Spectate",		PMENU_ALIGN_LEFT,	NULL, NULL );
	...
	client_menu (ent, 15, "Some patches by TOT+Kernel", PMENU_ALIGN_CENTER, NULL, NULL);

	client_menu(ent, 18, "Main Menu",						PMENU_ALIGN_CENTER,	NULL, M_Main_Menu );
	client_menu(ent, 19, "*Use [ and ] to select",			PMENU_ALIGN_CENTER,	NULL, NULL );
