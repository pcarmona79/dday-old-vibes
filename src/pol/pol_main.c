...
void InitFunctions(void)
{
	...
	Weapon_MG34_Fire = (void (*)(edict_t *ent)) PlayerFindFunction("Weapon_MG34_Fire");
	Weapon_PIAT_Fire = (void (*)(edict_t *ent)) PlayerFindFunction("Weapon_PIAT_Fire");
	Weapon_Sabre_Fire = (void (*)(edict_t *ent)) PlayerFindFunction("Weapon_Sabre_Fire");
}
...
{
	ptrgi->imageindex("scope_pol");
	ptrgi->imageindex("victory_pol");

	ptrgi->soundindex("pol/victory.wav");

	ptrgi->modelindex("players/pol/tris.md2");
	...
	// POL
	ptrgi->modelindex("players/pol/w_vis.md2");
	ptrgi->modelindex("players/pol/w_svt.md2");
	//	ptrgi->modelindex("players/pol/w_sten.md2");
	ptrgi->modelindex("players/pol/w_mors.md2");
	ptrgi->modelindex("players/pol/w_rkm.md2");
	ptrgi->modelindex("players/pol/w_mg34.md2");
	ptrgi->modelindex("players/pol/w_piat.md2");
	ptrgi->modelindex("players/pol/w_m98ks.md2");
	ptrgi->modelindex("players/pol/a_masher.md2");
	ptrgi->modelindex("players/pol/w_sabre.md2");

	// faf:  airstrike plane
	ptrgi->modelindex("models/ships/polplane/tris.md2");
...
static userdll_export_t userdll_export = {
	...
	POL_MOS_List,
	"pol", // team id
	"pol"  // this is the player model to use when spawning
};
...
userdll_export_t POLGetAPI(userdll_import_t udit)
{
