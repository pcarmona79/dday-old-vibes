 ...
 ************************************
 *   $Source: /var/lib/cvs/dday42sk/src/usa/usa_spawn.c,v $
 *   $Revision: 1.1.1.1 $
...
{
    SpawnItem(self, FindItemByClassnameInTeam("weapon_m1carb", "usa"));
}
...
{
    SpawnItem(self, FindItemByClassnameInTeam("ammo_m1carb", "usa"));
}
